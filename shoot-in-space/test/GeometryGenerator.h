...
public:
	...
	///</summary>
    static MeshData CreateBox(float width, float height, float depth, uint32_t numSubdivisions);
	...
	///</summary>
	static MeshData CreateGeosphere(float radius, uint32_t numSubdivisions);
