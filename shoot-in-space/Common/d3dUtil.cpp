    ...
    Microsoft::WRL::ComPtr<ID3D12Resource>& uploadBuffer)
{
	...
	ThrowIfFailed(device->CreateCommittedResource(
		&heapPropertiesDefault, // Now using the address of a named variable, which is an l-value
		D3D12_HEAP_FLAG_NONE,
		&bufferDesc, // Similarly, using the address of a named variable here
	...
	CD3DX12_RESOURCE_BARRIER barrierToGenericRead = CD3DX12_RESOURCE_BARRIER::Transition(
		defaultBuffer.Get(),
		D3D12_RESOURCE_STATE_COPY_DEST, 
		D3D12_RESOURCE_STATE_GENERIC_READ);
